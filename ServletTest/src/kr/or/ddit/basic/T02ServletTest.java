...
/*
    ...
    3.서블릿 컨테이너는 요청을 처리할 개별 스레드 객체를 생성하여
 	...
 	5.요청 처리가 완료되면 HttpServletRequest 및 HttpServletRespose객체는 소멸된다.
