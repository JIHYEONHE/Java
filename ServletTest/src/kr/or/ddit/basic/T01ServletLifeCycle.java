...
public class T01ServletLifeCycle extends HttpServlet {
	/*
	 * 서블릿이란? 컨테이너 (서블릿 엔진)에 의해 관리되는 자바기반 웹 컴포넌트로서, 동적인 웹 컨텐츠 생성을 가능하게 해준다.
	 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		throw new ServletException("서블릿 에러가 발생했어용");
	}
	
	@Override //클라이언트가 서버쪽으로 정보 보내는게 post
	...
	@Override
	public void destroy() {
		//객체 소멸시(컨테이너로 부터 서블릿객체 제거시 ) 필요한 코드 작성...
