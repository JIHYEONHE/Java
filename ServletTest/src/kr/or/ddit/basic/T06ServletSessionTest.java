...
public class T06ServletSessionTest extends HttpServlet {
	...
	/*
	     ...
	     -세션을 통해서 사용자(브라우져)별로 구분하여 정보를 관리 할 수 있다.(세션 ID 이용)
	     -쿠키를 사용 할 때 보다 보안이 향상된다.(정보가 서버에 저장되기 때문에...)
		...
		3.web.xml에 <session-config> 설정하기 (분단위) <session-timeout> 분<>
...
*/
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//session.setMaxInactiveInterval(10); //10초동안 아무 반응없으면 삭제
