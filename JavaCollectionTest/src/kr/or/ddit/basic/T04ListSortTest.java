...
public class T04ListSortTest {
   public static void main(String[] args) {
      ...
      System.out.println(mem1.equals(mem2));//false나옴 메모리에 홍길동을 3번주소에 만듬 
                                   //다른 홍길동을 7번주소에 만듬 오브젝트에서는 홍길동이 
                                   //서로 다른 주소에 있어서 false 나옴
      ...
      memList.add(new Member(2, "이순신", "010-1111-4444"));
      memList.add(new Member(3, "강감찬", "010-1111-5555"));
      memList.add(new Member(7, "일지매", "010-1111-6666"));
   ...
   class SortNumDesc implements Comparator<Member> {
      ...
      /*   if (mem1.getNum() > mem2.getNum()) {
         ...
         //Wrapper클래스에서 재공하는 메서드를 이용하는 방법
